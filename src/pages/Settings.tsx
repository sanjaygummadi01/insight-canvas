      ...
      <div className="space-y-6">
          ...
          <div className="flex items-center justify-between p-4 bg-muted/30 rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Current: {settings.theme === 'light' ? 'Light Mode' : 'Dark Mode'}</p>
              </div>
            </div>
        ...
        <div className="glass-card rounded-xl p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-muted/30 rounded-lg">
              <div className="flex items-center gap-3">
                <Icon name="refresh" className="w-5 h-5 text-primary" />
                <div>
                  <p className="font-medium text-foreground">Reset to Sample Data</p>
                  <p className="text-sm text-muted-foreground">Replace current data with sample analytics data</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-4 bg-destructive/5 border border-destructive/20 rounded-lg">
              <div className="flex items-center gap-3">
                <Icon name="trash" className="w-5 h-5 text-destructive" />
                <div>
                  <p className="font-medium text-foreground">Clear All Data</p>
                  <p className="text-sm text-muted-foreground">Permanently delete all data and reset the application</p>
                </div>
              </div>
        ...
        <div className="glass-card rounded-xl p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-muted/30 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Display currency for financial data</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-4 bg-muted/30 rounded-lg">
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 flex items-center justify-center text-primary font-mono text-xs">DD</div>
                <div>
                  <p className="font-medium text-foreground">Date Format</p>
                  <p className="text-sm text-muted-foreground">How dates are displayed in the app</p>
                </div>
              </div>
        ...
        <div className="glass-card rounded-xl p-6">
          ...
          <div className="space-y-2 text-sm">
            ...
            <p className="text-muted-foreground">A frontend-only data analytics dashboard built with React and TypeScript.</p>
