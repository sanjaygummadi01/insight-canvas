      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-chart-2/10 via-primary/10 to-chart-2/5 items-center justify-center p-8">
        <div className="max-w-md text-center">
          ...
          <p className="text-muted-foreground">
            Create beautiful dashboards, upload your data, and export insights 
            for Power BI - completely free.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <p className="text-muted-foreground mb-8">
            Get started with your free analytics dashboard
          </p>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-4 py-3 bg-card border rounded-xl text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all ${
                    getNameError() ? 'border-destructive' : 'border-border'
                  }`}
                />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className={`w-full pl-12 pr-4 py-3 bg-card border rounded-xl text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all ${
                    getConfirmPasswordError() ? 'border-destructive' : 'border-border'
                  }`}
                />
              </div>
