...
import { Moon, Sun, RefreshCw, Trash2, Globe } from 'lucide-react';
      ...
      <div className="space-y-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Current: {settings.theme === 'light' ? 'Light Mode' : 'Dark Mode'}
                </p>
              </div>
            </div>
            <button
              onClick={toggleTheme}
              className="relative w-14 h-7 bg-muted rounded-full transition-colors duration-200"
            >
              <span 
            ...
            <div className="flex items-center justify-between p-4 bg-muted/30 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Replace current data with sample analytics data
                  </p>
                </div>
              </div>
              <button
            ...
            <div className="flex items-center justify-between p-4 bg-destructive/5 border border-destructive/20 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Permanently delete all data and reset the application
                  </p>
                </div>
              </div>
              <button
                onClick={handleResetAll}
                className="px-4 py-2 bg-destructive text-destructive-foreground text-sm font-medium rounded-lg hover:opacity-90 transition-opacity"
              >
                Clear All
              </button>
            </div>
        ...
        <div className="glass-card rounded-xl p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-4 bg-muted/30 rounded-lg">
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 flex items-center justify-center text-primary font-mono text-xs">
                  DD
                </div>
                <div>
        ...
        <div className="glass-card rounded-xl p-6">
          ...
          <div className="space-y-2 text-sm">
            <p className="text-muted-foreground">
              <span className="text-foreground font-medium">DataViz Analytics</span> v1.0.0
            </p>
            <p className="text-muted-foreground">
              A frontend-only data analytics dashboard built with React and TypeScript.
            </p>
            <p className="text-muted-foreground">
